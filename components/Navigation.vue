        ...
        <div class="container mx-auto flex items-center">
            ...
            <div class="flex w-1/2 pl-4 text-sm">
                <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                    <li class="mr-2">
                        <NuxtLink class="inline-block py-2 px-2 text-white no-underline hover:underline"
                            to="/">HOME</NuxtLink>
                    </li>
                    <li class="mr-2">
                        <NuxtLink class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-2"
                            to="/about">ABOUT</NuxtLink>
                    </li>
                    <li class="mr-2">
                        <Nuxt-Link class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-2"
